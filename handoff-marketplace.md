...
### This pass — payment reference moved SERVER SIDE + edge function wired live
...
## 6. Next steps
1. **Checkout is live** (bank-transfer checkout + awaiting payment, edge function
   deployed, bank details set, verified live). Still to build next: admin marks
   payment received, order tracking (design T3), and confirm-or-dispute (T4).
