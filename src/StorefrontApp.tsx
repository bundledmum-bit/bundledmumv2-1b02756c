...
import MarketplaceOutreach from "@/pages/admin/marketplace/MarketplaceOutreach";
import MarketplaceAbandonedCheckouts from "@/pages/admin/marketplace/MarketplaceAbandonedCheckouts";
import MarketplacePendingPayments from "@/pages/admin/marketplace/MarketplacePendingPayments";
import MarketplaceAwaitingConfirmation from "@/pages/admin/marketplace/MarketplaceAwaitingConfirmation";
import MarketplaceListingsNeedingVideo from "@/pages/admin/marketplace/MarketplaceListingsNeedingVideo";
import MarketplaceVideosToReview from "@/pages/admin/marketplace/MarketplaceVideosToReview";
import MarketplaceSearchDemand from "@/pages/admin/marketplace/MarketplaceSearchDemand";
import MarketplacePromoClicks from "@/pages/admin/marketplace/MarketplacePromoClicks";
...
import MarketplaceBuyers from "@/pages/admin/marketplace/MarketplaceBuyers";
...
import MarketplaceOnBehalfLog from "@/pages/admin/marketplace/MarketplaceOnBehalfLog";
import MarketplaceSearchAliases from "@/pages/admin/marketplace/MarketplaceSearchAliases";
import MarketplaceNeverListed from "@/pages/admin/marketplace/MarketplaceNeverListed";
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/admin" element={<AdminLayout />}>
                ...
                <Route path="marketplace" element={<PermissionGate module="marketplace" action="manage"><MarketplaceDashboard /></PermissionGate>} />
                ...
                <Route path="marketplace/outreach" element={<PermissionGate module="marketplace" action="manage"><MarketplaceOutreach /></PermissionGate>} />
                <Route path="marketplace/abandoned" element={<PermissionGate module="marketplace" action="manage"><MarketplaceAbandonedCheckouts /></PermissionGate>} />
                <Route path="marketplace/pending-payments" element={<PermissionGate module="marketplace" action="manage"><MarketplacePendingPayments /></PermissionGate>} />
                <Route path="marketplace/awaiting-confirmation" element={<PermissionGate module="marketplace" action="manage"><MarketplaceAwaitingConfirmation /></PermissionGate>} />
                <Route path="marketplace/needs-video" element={<PermissionGate module="marketplace" action="manage"><MarketplaceListingsNeedingVideo /></PermissionGate>} />
                <Route path="marketplace/videos-to-review" element={<PermissionGate module="marketplace" action="manage"><MarketplaceVideosToReview /></PermissionGate>} />
                <Route path="marketplace/search-demand" element={<PermissionGate module="marketplace" action="manage"><MarketplaceSearchDemand /></PermissionGate>} />
                <Route path="marketplace/promo-clicks" element={<PermissionGate module="marketplace" action="manage"><MarketplacePromoClicks /></PermissionGate>} />
                ...
                <Route path="marketplace/buyers" element={<PermissionGate module="marketplace" action="manage"><MarketplaceBuyers /></PermissionGate>} />
                ...
                <Route path="marketplace/on-behalf" element={<PermissionGate module="marketplace" action="manage"><MarketplaceOnBehalfLog /></PermissionGate>} />
                <Route path="marketplace/search-words" element={<PermissionGate module="marketplace" action="manage"><MarketplaceSearchAliases /></PermissionGate>} />
                <Route path="marketplace/never-listed" element={<PermissionGate module="marketplace" action="manage"><MarketplaceNeverListed /></PermissionGate>} />
