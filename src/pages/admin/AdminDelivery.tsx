...
export default function AdminDelivery() {
  ...
  return (
    <div>
      {/* Free Delivery Thresholds moved to the Promotions section so
          spend-based offers live together. The five legacy
          free_delivery_nationwide_* site_settings keys are still read
          by checkout in the interim while the storefront switches over
          to the new free_delivery_thresholds table. */}
      <div className="mb-6 flex items-start gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2.5 text-[12px] text-blue-900">
        <Info className="w-4 h-4 mt-[1px] flex-shrink-0" />
        <p>
          Free Delivery Thresholds are now managed in the Promotions section (
          <Link to="/admin/promotions" className="font-semibold underline">Promotions → Free Delivery Thresholds</Link>
          ).
        </p>
      </div>
