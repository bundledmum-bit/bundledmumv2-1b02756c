            ...
            <div className="md:hidden flex flex-col items-center shrink-0">
              ...
              >
                <svg viewBox="0 0 32 32" className="w-7 h-7" fill="currentColor" aria-hidden="true">
                  <path d="M19.11 17.205c-.372 0-1.088 1.39-1.518 1.39a.63.63 0 0 1-.315-.1c-.802-.402-1.504-.817-2.163-1.447-.545-.516-1.146-1.29-1.46-1.963a.426.426 0 0 1-.073-.215c0-.33.99-.945.99-1.49 0-.143-.73-2.09-.832-2.335-.143-.372-.214-.487-.6-.487-.187 0-.36-.043-.53-.043-.302 0-.53.115-.746.315-.688.645-1.032 1.318-1.06 2.264v.114c-.015.99.472 1.977 1.017 2.78 1.23 1.82 2.506 3.41 4.554 4.34.616.287 2.035.888 2.722.888.817 0 2.15-.515 2.478-1.318.13-.33.244-.73.244-1.088 0-.058 0-.144-.03-.215-.085-.144-2.335-1.39-2.678-1.39zm-2.84 7.593c-1.747 0-3.48-.53-4.942-1.49L7.45 24.61l1.32-3.917a8.93 8.93 0 0 1-1.7-5.244c0-4.943 4.02-8.964 8.964-8.964 4.944 0 8.964 4.02 8.964 8.964 0 4.943-4.02 8.963-8.964 8.963zm0-19.71c-5.91 0-10.747 4.81-10.747 10.747 0 1.89.487 3.748 1.418 5.38L5 27.495l5.448-1.748a10.69 10.69 0 0 0 5.122 1.304c5.91 0 10.747-4.81 10.747-10.747 0-5.91-4.81-10.748-10.747-10.748z"/>
                </svg>
              </a>
            </div>
          )}
