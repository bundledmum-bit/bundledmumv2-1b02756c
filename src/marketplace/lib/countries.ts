 ...
 * one country (e.g. +1 across NANP, +44 GB/Jersey/Guernsey/Isle of Man) —
 * that's expected, only the dial code itself matters for validation and
 * storage, not which specific country was picked.
 */
